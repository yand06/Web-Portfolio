        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {skills.map((skillSet) => (
            <div
              ...
              className="group relative bg-white p-8 rounded-3xl border-2 border-slate-200 hover:border-indigo-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
            >
              {/* Icon */}
              <div className="mb-6">
                <div className="w-14 h-14 bg-slate-100 rounded-2xl flex items-center justify-center text-2xl group-hover:bg-indigo-50 transition-colors duration-300">
                  {skillSet.icon}
                </div>
              </div>
              ...
              <ul className="space-y-3">
                {skillSet.items.map((item, idx) => (
                  ...
                  >
                    <div className="w-6 h-6 rounded-lg bg-slate-100 flex items-center justify-center mr-3 group-hover:bg-indigo-100 transition-colors duration-300">
              ...
              {/* Decorative Corner */}
              <div className="absolute -top-1 -right-1 w-8 h-8 bg-indigo-500 rounded-br-3xl rounded-tl-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </div>
          ))}
        </div>
